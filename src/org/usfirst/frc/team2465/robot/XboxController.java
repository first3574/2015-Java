...
public class XboxController {
	 ...
	 */
	     ...
	     */
	    double GetLeftX() {
	        return Math.pow(xbox.getRawAxis(1), joystickCurve);
	    }

	    double GetLeftY() {
	        return Math.pow(xbox.getRawAxis(2), joystickCurve);
	    }

	    double GetLeftTrigger() {
	        double trigger = Math.pow(xbox.getRawAxis(3), joystickCurve);
	    ...
	    double GetRightX() {
	        return Math.pow(xbox.getRawAxis(4), joystickCurve);
	    }

	    double GetRightY() {
	        return Math.pow(xbox.getRawAxis(5), joystickCurve);
	    }
